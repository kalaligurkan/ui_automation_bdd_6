@Project05
Feature: TechGlobal page functionality
  ...
  Background:
    ...
    Scenario: Test Case 01 - Validate the main content
      ...
      Then the user sees the "Pagination" heading
      And the user sees the "World City Populations 2022" heading
      And the user sees the "What are the most populated cities in the world? Here is a list of the top five most populated cities in the world:" paragraph
